    ...
    <main className="About-us">
      ...
      <div>
        ...
        <hgroup>
          ...
          <p>
            تشجيع الطلاب على التفكير في قضايا المجتمع وفهم احتياجاته، بهدف تعزيز
            الوعي الاجتماعي لديهم.
          </p>
        </hgroup>
        ...
        <hgroup>
          ...
          <p>
            إتاحة الفرصة للطلاب لتقديم أفكارهم الإبداعية والتفكير بحلول إيجابية
        ...
        <hgroup>
          ...
          <p>
             يتم استعراض الأفكار المقترحة، وتُختار الأفكار البارزة لتكون
     جزءًا من مشاريع تطوعية حقيقية يشارك فيها الطلاب .
          </p>
        </hgroup>
      </div>
    </main>
